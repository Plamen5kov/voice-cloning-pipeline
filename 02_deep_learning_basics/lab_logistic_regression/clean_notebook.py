#!/usr/bin/env python3
"""
Clean the notebook by removing all outputs, execution counts, and student solutions.
            ...
            if 'YOUR CODE STARTS HERE' in source and 'YOUR CODE ENDS HERE' in source:
                ...
                for i, line in enumerate(lines):
                    if 'YOUR CODE STARTS HERE' in line:
                        ...
                        # Add blank line after start marker
                        new_lines.append('\n')
...
if __name__ == '__main__':
    notebook_path = 'audio_classification_logreg.ipynb'
